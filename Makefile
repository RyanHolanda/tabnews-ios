.PHONY: test
test:
	@xcodebuild test -scheme TabNewsSnapshotTests -destination 'platform=iOS Simulator,name=iPhone 15' && xcodebuild test -scheme TabNewsUnitTests -destination 'platform=iOS Simulator,name=iPhone 15'
